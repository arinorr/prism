...
1. [Testing Plan](plans/testing-plan.md) — real PR before/after testing (8 PRs across 3 repos) + unit test coverage gaps
...
3. [Prompt Cache Optimization](plans/completed/prompt-cache-optimization.md) — shared system prompt prefix, sorted files, metadata-first user prompt, normalizePrompt
