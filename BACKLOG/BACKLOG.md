...
4. [Git Package](plans/git-package.md) — consolidate git operations into internal/git/, add shallow clone for cross-repo PR review
5. [Auto Verifier Budget](plans/auto-verifier-budget.md) — derive verifier budget from estimated agent cost instead of requiring manual config
